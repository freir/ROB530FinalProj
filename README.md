...
TODO: ROB describe key changes and how to run drift with the tartan code. 

TODO: ROB describe process of converting the rosbag for wheel speed to csv, looking up the data for the current time, and publishing to ROS
